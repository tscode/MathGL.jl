...
function mesh(gr::AbstractGraph, z::Array{mgl.Float, 2}; sch::ASCIIString="", opt::ASCIIString="")
    mgl.mesh(gr.ptr, Data(z).ptr, sch, opt)
end

function mesh(gr::AbstractGraph, x::Array{mgl.Float, 2}, y::Array{mgl.Float, 2}, z::Array{mgl.Float, 2}; sch::ASCIIString="", opt::ASCIIString="")
    mgl.mesh_xy(gr.ptr, Data(x).ptr, Data(y).ptr, Data(z).ptr, sch, opt)
end
